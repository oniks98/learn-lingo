      ...
      classNames={{
        ...
        dropdowns: cn(
          clsx(
            ...
            'justify-center h-(--cell-size) gap-1.5',
          ),
        ...
        weekday: cn(
          clsx(
            'text-muted-foreground rounded-md flex-1 font-normal',
    ...
    <Button
      ...
      className={cn(
        clsx(
          ...
          'data-[range-end=true]:bg-yellow-400 data-[range-end=true]:text-black',
          'data-[range-end=true]:hover:bg-yellow-500',
          'data-[range-start=true]:rounded-md data-[range-start=true]:rounded-l-md',
          'data-[range-start=true]:bg-yellow-400 data-[range-start=true]:text-black',
          'data-[range-start=true]:hover:bg-yellow-500',
          // Single selection стилі
          'data-[selected-single=true]:bg-yellow-400 data-[selected-single=true]:text-black',
