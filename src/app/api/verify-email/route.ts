...
export async function POST(request: NextRequest) {
  try {
    ...
    // Принудительно обновляем статус верификации в Firebase Auth не нужно
    // oobCode автоматически обновляет статус в Firebase Auth
    // try {
    //   await admin.auth().updateUser(userRecord.uid, {
    //     emailVerified: true,
    //   });
    //   console.log('Updated emailVerified status in Firebase Auth');
    // } catch (error) {
    //   console.error('Failed to update emailVerified in Firebase Auth:', error);
    // }
